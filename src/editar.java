...
public class editar extends javax.swing.JFrame
{
    ...
    {   
        try {
            ...
            List<Empleado> lista= c.buscar(this.claveactual);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            int estatus= c.actualizar(clave, nombre, sueldo, diastr, total);
            if(estatus==1)
            {
            ...
            {
                JOptionPane.showMessageDialog(null, "No fue posible actualizar la información."+
                        "\nFavor de reintentar y revisar la información",
                        "Algo va mal", JOptionPane.WARNING_MESSAGE);
            }
        }
